...
function spawnHeart() {
  ...
  heart.addEventListener("click", () => {
    ...
    if (Math.random() < 0.5) {
      const voice = Math.random() < 0.4 ? document.getElementById("voz1") : document.getElementById("voz2");
      voice.play();
    }
...
function updateProgressBar(score) {
  ...
  if (progress < 30) {
    progressBar.style.background = "linear-gradient(90deg,rgb(0, 102, 255),rgb(18, 101, 164))"; // Vermelho
  } else if (progress < 70) {
    progressBar.style.background = "linear-gradient(90deg,rgb(84, 27, 98),rgb(201, 110, 247))"; // Amarelo
  } else {
    progressBar.style.background = "linear-gradient(90deg,rgb(254, 23, 162),rgb(246, 139, 160))"; // Verde
  }
}
